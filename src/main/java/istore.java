...
System.out.println("WELCOME TO iSTOREyahe");
System.out.println("Pili mga suki");
System.out.println("1 - Chicken fillet = 69pesos");
int chicken = 69;
System.out.println("2 - Burger steak = 56pesos");
int burger = 56;
System.out.println("3 - Grilled fish = 48pesos");
int fish = 48;
System.out.println("4 - Pineapple juice = 15pesos");
int juice = 15;
System.out.println("5 - Cocacola = 16pesos");
int coke = 16;
int a = input.nextInt();
        if (a <= 1){
            System.out.println("(PROMO! If you order 3 Chicken fillets, you get a 30pesos off)");
